...
class Eagle3OneModelWorker(HelixMTPWorkerMixin, SpecWorkerBase):
...
class MTPEagleWorker(Eagle3OneModelWorker):
    ...
    that import ``MTPEagleWorker`` from the speculative package or instantiate
    it directly keep working. All logic is inherited from
    :class:`Eagle3OneModelWorker`.
    """
